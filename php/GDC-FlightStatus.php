...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../styles/GDC-HomeConnCSSn.css">
	<style type="text/css">
		h1{
			margin-left: 23.5%;
			color: white;
	...
	<nav class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand"><img src="../Images/syriaflag.jpg" id="logo"> GDC AIRWAYS</a>
